...
Use `docs/native-vs-mempalace-contract.md` for the canonical semantic boundary between native platform records and MemPalace retrieval.
...
- If native-vs-mempalace semantics are unclear, review `docs/native-vs-mempalace-contract.md`.
