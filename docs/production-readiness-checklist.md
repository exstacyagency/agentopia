...
- [x] Add memory deletion workflows
- [x] Add fallback behavior when MemPalace is unavailable
...
- [x] Add task status and history visibility
...
- [x] Add end-to-end HTTP/process tests
